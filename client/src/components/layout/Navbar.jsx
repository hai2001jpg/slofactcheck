                ...
                <div className="hidden lg:flex items-center gap-12">
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="flex gap-4 montserrat text-md">
                            <Link to="/login"><button className="text-white px-4 py-2 rounded-md border border-[rgb(58,58,58)] hover:border-white transition duration-300 text-nowrap cursor-pointer">Log In</button></Link>
                            <Link to="/login"><button className="bg-blue-600 text-white px-4 py-2 rounded-md border border-blue-600 hover:border-white transition duration-300 text-nowrap cursor-pointer">Sign Up</button></Link>
                        </div>
                    )}
                </div>
                ...
                <div className="lg:hidden">
                    ...
                    >
                        <div className="max-w-screen-xl mx-auto px-4 flex flex-col gap-4 items-center py-4">
                            <button onClick={() => scrollToSection("home")} className="w-full text-white bebas-neue text-2xl sm:text-lg cursor-pointer hover:text-gray-300 hover:translate-y-1 transition duration-300">Home</button>
                            <button onClick={() => scrollToSection("about")} className="w-full text-white bebas-neue text-2xl sm:text-lg cursor-pointer hover:text-gray-300 hover:translate-y-1 transition duration-300">About SFC</button>
                            <button onClick={() => scrollToSection("contact")} className="w-full text-white bebas-neue text-2xl sm:text-lg cursor-pointer hover:text-gray-300 hover:translate-y-1 transition duration-300">Contact</button>
                            {isAuthenticated ? (
