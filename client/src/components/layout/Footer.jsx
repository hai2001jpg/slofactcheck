            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
                ...
                <div className="flex flex-row flex-wrap justify-center gap-4 sm:gap-6 fade-in mt-4 md:mt-0">
                    <a href="https://kemt.fei.tuke.sk/" target="_blank" rel="noopener noreferrer"
                        className="p-3 sm:p-4 border border-gray-600 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex justify-center items-center hover:bg-gray-900 transition duration-300">
                        <LazySVG>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" fill="white" className="bi bi-globe2" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.facebook.com/kemt.sk" target="_blank" rel="noopener noreferrer"
                        className="p-3 sm:p-4 border border-gray-600 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex justify-center items-center hover:bg-gray-900 transition duration-300">
                        <LazySVG>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" fill="white" className="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                            </svg>
                        </LazySVG>
                    </a>
                    <a href="https://www.instagram.com/kemt_fei_tuke/" target="_blank" rel="noopener noreferrer"
                        className="p-3 sm:p-4 border border-gray-600 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex justify-center items-center hover:bg-gray-900 transition duration-300">
                        <LazySVG>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" fill="white" className="bi bi-instagram" viewBox="0 0 16 16">
