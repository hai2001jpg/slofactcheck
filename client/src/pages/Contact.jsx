...
const Contact = () => {
    ...
    return (
        <div id="contact" className="w-full flex flex-col items-center my-8 bg-[linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.95)_10%,rgba(0,0,0,0.95)_90%,transparent_100%)]">
            <div className="w-full max-w-7xl px-4 sm:px-8 md:px-16 lg:px-32 flex flex-col md:flex-row justify-evenly gap-8 md:gap-0">
                <div className="flex flex-col gap-4 md:max-w-[50%] w-full">
                    <h5 className="font-[Montserrat] text-xl text-blue-500 font-bold fade-in-hidden">Contact</h5>
                    <h1 className="font-[Montserrat] text-5xl text-white font-bold fade-in-hidden">Let us know how we can help</h1>
                    ...
                    <div className="text-white flex flex-row gap-2 items-center fade-in-hidden">
                        <LazySvg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1vw" height="1vw" fill="white" class="bi bi-envelope" viewBox="0 0 16 16">
                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                            </svg>
                        </LazySvg>
                        <span className="inter-font">kemt.fei@tuke.sk</span>
                    </div>
                    <div className="text-white flex flex-row gap-2 items-center fade-in-hidden">
                        <LazySvg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1vw" height="1vw" fill="white" class="bi bi-telephone" viewBox="0 0 16 16">
                    ...
                    <div className="text-white flex flex-row gap-2 items-center fade-in-hidden">
                        <LazySvg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1vw" height="1vw" fill="white" class="bi bi-geo-alt" viewBox="0 0 16 16">
                ...
                <form className="flex flex-col w-full md:w-[50%] py-4 mt-5 gap-4 items-center">
                    ...
                    <div className="w-full sm:w-96 flex flex-col gap-1 fade-in-hidden">
                        <label htmlFor="subject" className="text-gray-400 text-sm font-[Montserrat]">
                            Subject
                        </label>
                    ...
                    <div className="w-full sm:w-96 flex flex-col gap-1 fade-in-hidden">
                        <label htmlFor="message" className="text-gray-400 text-sm font-[Montserrat]">
                            Message
                        </label>
